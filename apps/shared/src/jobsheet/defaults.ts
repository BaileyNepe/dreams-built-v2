...
export const DEFAULT_JOBSHEET_RULES: JobSheetRules = {
  ...
  // Confirmed by Bailey 2026-07-12: shutter boards are 45mm (the prototype's
  // 65 was a guess). Absorbs, overhang caps and BLK thickness all key off this.
  shutterThicknessMm: 45,
